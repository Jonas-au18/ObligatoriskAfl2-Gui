...
namespace Hotel_California.Controllers
{
    public class GuestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FirstName,LastName,Age,RoomNr")] Guest guest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GuestID,FName,LName,Age")] Guest guest)
        {
            if (id != guest.GuestID)
            {
                return NotFound();
